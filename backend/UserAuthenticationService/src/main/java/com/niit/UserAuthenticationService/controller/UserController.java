...
public class UserController {
    ...
    public ResponseEntity<?> registerFunction(@RequestBody Operation operation) throws UserAlreadyPresentException {
        return new ResponseEntity<>(userService.savequestion(operation), HttpStatus.CREATED);
    }
    @PostMapping("saveanswer")
    public ResponseEntity<?> saveanswer(@RequestBody Operation operation)  {
        return new ResponseEntity<>(userService.saveanswer(operation.getAnswer(),operation.getQ_id()), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<?> displaystudentprofile()
    {
        return new ResponseEntity<>(userService.findstudent(), HttpStatus.OK);
    }
    ...
    @GetMapping("fetchquestionbyemail/{email}")
    public ResponseEntity<?> displayAllproduct(@PathVariable String email)
    {
        System.out.println(email);
        return new ResponseEntity<>(userService.fetchquestion(email), HttpStatus.OK);
    }
